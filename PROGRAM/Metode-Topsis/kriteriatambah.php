  ...
  <body>
                ...
                <div class="panel-body">
                    ...
                    <div class="tab-content">
                      ...
                      <form class="form" action="kriteriatambah.php" method="post">
						...
						<div class="form-group">
                          <input class="form-control" type="text" name="Atribut" placeholder="atribut">
                        </div>
                        <div class="form-group">
    ...
    <footer class="text-center">
      <div class="footer-below">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <em>Copyright &copy; Pemilihan Rumah Sakit Terbaik di Yogyakarta</em>
            </div>
          </div>
        </div>
      </div>
    ...
    if (isset($_POST['simpan'])) {
      ...
      if ($row = $tambah->fetch_row()) {
        ...
        $masuk = "INSERT INTO tab_kriteria VALUES ('".$id_krit."','".$kriteria."','".$Atribut."','".$bobot."')";
